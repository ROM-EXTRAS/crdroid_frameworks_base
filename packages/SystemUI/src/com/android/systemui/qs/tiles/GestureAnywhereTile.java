...
public class GestureAnywhereTile extends QSTileImpl<BooleanState> {
    ...
    private static final ComponentName GESTURE_ANYWHERE_SETTINGS_COMPONENT = new ComponentName(
            "com.android.settings", "com.android.settings.Settings$GestureAnywhereSettings");
    private static final Intent GESTURE_ANYWHERE_SETTINGS =
	    new Intent().setComponent(GESTURE_ANYWHERE_SETTINGS_COMPONENT);
